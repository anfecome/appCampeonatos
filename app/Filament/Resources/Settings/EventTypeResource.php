...
use App\Filament\Resources\Settings\EventTypeResource\Pages;
use BackedEnum;
use Filament\Forms;
...
class EventTypeResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Forms\Components\Toggle::make('affects_score')
                ->label('Affects Score'),

            Forms\Components\Toggle::make('is_sanction')
                ->label('Is Sanction'),

            Forms\Components\Toggle::make('requires_player')
                ->label('Requires Player'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                IconColumn::make('affects_score')->boolean()->label('Score'),
                IconColumn::make('is_sanction')->boolean()->label('Sanction'),
